...
public class SnakeResourceTest {
  ...
  void setUp() {
    ...
    when(snakeService.getSnakeById(ownerId.toString(), wrongId))
        .thenThrow(InternalServerErrorException.class);
    when(snakeService.getSnakesByOwnerId(ownerId.toString()))
        .thenReturn(Collections.singletonList(snake));
  ...
  public void testDeleteSnakeById_error() {
    ...
    Assertions.assertEquals(
        "Was not able to delete the snake", response.getBody().asPrettyString());
  }
}
